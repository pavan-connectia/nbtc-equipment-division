    ...
    <div className="mx-auto mt-20 flex max-w-[1280px] flex-wrap items-center gap-5 px-3 py-10 md:gap-8 lg:gap-10">
      ...
      <div className="space-y-5 lg:w-[40%]">
        <div className="space-y-2">
          <div className="flex items-center font-kanit gap-x-3 text-blue">
            <div >
              <Img src={journey} className="object-contain p-1 size-8" />
            </div>
        ...
        <div className="space-y-2">
          <div className="flex items-start font-kanit gap-x-3 text-blue">
            <div >
              <Img src={mission} className="object-contain p-1 size-8" />
            </div>
            <h5 className="text-lg font-medium">{t("home.mission")}</h5>
          </div>
          <SetInnerHtml
            className="text-sm font-lato text-blue"
        ...
        <div className="space-y-2">
          <div className="flex items-start font-kanit gap-x-3 text-blue">
            <div >
              <Img src={vision} className="object-contain p-1 size-8" />
            </div>
        ...
        <div className="space-y-2">
          <div className="flex items-start font-kanit gap-x-3 text-blue">
            <div >
              <Img src={values} className="object-contain p-1 size-8" />
            </div>
